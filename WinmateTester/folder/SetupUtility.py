...
def copy_tree_with_progress(src_folder, dst_folder):
    ...
    try:
        ...
        try:
            ...
            pass
        time.sleep(0.5)
        shutil.copy('.\\0\\SetupUtility\\apps\\UltraVNC.ini', vnc_dst_folder)
        shutil.copy('.\\0\\SetupUtility\\apps\\winvnc.exe', vnc_dst_folder)
        with open("VNC_install_log.txt", 'a') as file:
...
if __name__ == "__main__":
    ...
    if report is False:
        with open('\\log\\ERROR_report.txt', 'a') as errfile:
