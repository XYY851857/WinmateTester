...
def bt():
    ...
    try:
        result = subprocess.run('0\\Winmate_Test_GUI\\exes_stable\\BT_subprocess.exe', capture_output=True, text=True)
...
def ping():
    ...
    try:
        result = subprocess.run('0\\Winmate_Test_GUI\\exes_stable\\PingTest_subprocess.exe', capture_output=True, text=True)
        output = result.stdout
    except Exception as e:
        output = str(e)
...
def wr():
    ...
    try:
        result = subprocess.run('0\\Winmate_Test_GUI\\exes_stable\\WR_subprocess.exe', capture_output=True, text=True)
        output = result.stdout
    except Exception as e:
        output = str(e)
...
def rs485():
    ...
    try:
        result = subprocess.run('0\\Winmate_Test_GUI\\exes_stable\\RS485.exe', capture_output=True, text=True)
        output = result.stdout
    except Exception as e:
        output = str(e)
...
if __name__ == "__main__":
    ...
    exes = [
        '.\\0\\Winmate_Test_GUI\\exes_stable\\BT_subprocess.exe',
        '.\\0\\Winmate_Test_GUI\\exes_stable\\PingTest_subprocess.exe',
        '.\\0\\Winmate_Test_GUI\\exes_stable\\WR_subprocess.exe',
        '.\\0\\Winmate_Test_GUI\\exes_stable\\RS485.exe'
    ]
    button_width = 23
    button_height = 3
